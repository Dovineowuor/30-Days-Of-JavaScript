...
console.log("My pet cat's name is: ", petCat); // declaring another variables

var catSound = "purr";
var dogSound = "woof";
console.log(petDog, "says", dogSound);
console.log(petCat, "says", catSound); // Reassigning the variables with the new appropriate values
